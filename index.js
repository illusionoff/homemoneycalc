...
// для доступа express к прототипу
...
// const { settingsDelValidators } = require("./utils/validators");
// var multer  = require('multer'); // Для загрузки файлов в проекте не используется
// app.engine('hbs', expressHandlebars({// для доступа express к прототипу Не работает
...
app.use(
  helmet.contentSecurityPolicy({
    directives: {
      ...
      // connectSrc: ["'self'", 'https://ka-f.fontawesome.com/releases/v5.15.1/css/free.min.css'],
